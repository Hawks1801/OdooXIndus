...
export async function PUT(
  ...
  try {
    ...
    const transformedOrder = {
      ...
      shippingAddress: orderWithItems.shippingAddress ? JSON.parse(orderWithItems.shippingAddress as string) : null,
      billingAddress: orderWithItems.billingAddress ? JSON.parse(orderWithItems.billingAddress as string) : null,
