      ...
      >
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="flex flex-col gap-2">
            <label
              htmlFor="file-upload"
              className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-xl cursor-pointer bg-white/10 dark:bg-white/5 backdrop-blur-sm hover:bg-white/20 dark:hover:bg-white/10 transition-colors "
            >
        ...
        <DialogFooter className="mt-9 mb-4">
          <Button
            ...
            disabled={isImporting}
            className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border border-white/10 dark:bg-background/50 backdrop-blur-sm   transition duration-200 dark:hover:bg-accent/50 hover:border-white/20 dark:hover:border-white/20  dark: text-white"
          >
