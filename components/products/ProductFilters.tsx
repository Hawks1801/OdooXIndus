...
export default function FiltersAndActions({
  ...
  const exportButtonClass =
    "h-10 w-full sm:w-auto flex items-center gap-2 rounded-[28px] border          text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200     dark:   ";
      ...
      {productOwnerOptions && onOwnerChange && (
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3 w-full">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="start"
              className="rounded-[28px] border dark:border-white/10 bg-white/80 dark:bg-popover/50 backdrop-blur-sm min-w-[200px]"
            >
...
function FilterArea({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3 poppins">
      {/* Status Filter */}
      {selectedStatuses.length > 0 && (
        <div className="inline-flex items-center gap-1 px-2 py-1 text-xs border text-gray-700 dark:text-white sm:text-white rounded-md backdrop-blur-sm ">
