...
export default function SupportTicketDialog({
  ...
  const iconBorderClass = isViolet
    ? " bg-violet-100/50  dark:bg-violet-500/20"
    : " bg-sky-100/50  dark:bg-sky-500/20";
  const iconColorClass = isViolet
    ? "text-violet-400"
    : "text-sky-400";
  const inputClass = isViolet
    ? "border  border-white/20 bg-white/10 text-white placeholder:text-white/40 focus-visible:outline-none focus-visible:border focus-visible: focus-visible:ring-2 focus-visible:ring-violet-500/50 focus:outline-none focus:border  focus:ring-2 focus:ring-violet-500/50 "
    : "border  border-white/20 bg-white/10 text-white placeholder:text-white/40 focus-visible:outline-none focus-visible:border focus-visible: focus-visible:ring-2 focus-visible:ring-sky-500/50 focus:outline-none focus:border  focus:ring-2 focus:ring-sky-500/50 ";
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          {productOwners.length > 0 && (
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent
                  className="rounded-xl dark:border-white/10 bg-white/95 dark:bg-popover/95 backdrop-blur-sm"
                  position="popper"
                  sideOffset={5}
                >
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent
                className="rounded-xl dark:border-white/10 bg-white/95 dark:bg-popover/95"
                position="popper"
                sideOffset={5}
              >
                {PRIORITIES.map((p) => (
