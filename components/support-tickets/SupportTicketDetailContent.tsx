      ...
      <PageContentWrapper>
        <div className="space-y-6 poppins">
          ...
          >
            ...
            <div className="rounded-xl bg-white/40 dark:bg-white/5 border dark:border-white/10 p-4">
          ...
          >
                ...
                {replies.map((r) => {
                  ...
                  return (
                    <li
                      key={r.id}
                      className={cn(
                        "rounded-xl border  dark:border-white/10 p-4",
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        <Image
                          ...
                          width={32}
                          height={32}
                          className="h-8 w-8 rounded-full object-cover border dark:border-white/30 flex-shrink-0"
                          unoptimized
                          onError={(e) => {
            ...
            <form onSubmit={handleSubmitReply} className="space-y-3">
              <Textarea
                ...
                className="min-h-[100px] rounded-xl dark:border-white/20 bg-white/80 dark:bg-white/5 text-gray-900 dark:text-white placeholder:text-gray-500 resize-none"
              />
              <Button
                type="submit"
                disabled={createReply.isPending || !replyBody.trim()}
                className={cn(
                  "rounded-xl border     text-white gap-2",
                  "",
                  " ",
                )}
              >
