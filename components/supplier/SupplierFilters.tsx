      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        ...
        <div className="relative flex-1 sm:max-w-md">
          ...
          <Input
            ...
            className="h-10 pl-9 pr-10 w-full rounded-[28px] bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 focus-visible: focus-visible:ring-sky-500/50 "
          />
          {searchTerm && (
            <Button
              variant="ghost"
