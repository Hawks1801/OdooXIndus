    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="p-4 sm:p-7 sm:px-8 poppins max-h-[90vh] overflow-y-auto  ">
          ...
          <div className="mt-4">
            <div className="pb-4">
              ...
              <Input
                ...
                className="mt-2 w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-white placeholder:text-white/40 focus-visible: focus-visible:ring-emerald-500/50 "
              />
            </div>
            <div className="pb-4">
              <Label className="text-sm font-medium mb-2 block text-white/80 dark:text-white/80">
            ...
            <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
              <Button
                ...
                variant="secondary"
                className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border border-white/10 dark:border-white/10 dark:bg-background/50 backdrop-blur-sm   transition duration-200 dark:hover:bg-accent/50 hover:border-white/20 dark:hover:border-white/20  dark:"
              >
                Cancel
              </Button>
              <Button
                onClick={handleUpdateSupplier}
                className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border dark:border-primary/30 dark:from-primary/70 dark:via-primary/50 dark:to-primary/30 text-white  backdrop-blur-sm transition duration-200 dark:hover:border-primary/40 dark:hover:from-primary/80 dark:hover:via-primary/60 dark:hover:to-primary/40"
                disabled={isEditing}
              >
          ...
          <>
            <div className="pb-4">
              <Input
                ...
                className="mt-4 w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-white placeholder:text-white/40 focus-visible: focus-visible:ring-emerald-500/50 "
              />
            </div>
            <div className="pb-4">
              <Label className="text-sm font-medium mb-2 block text-white/80 dark:text-white/80">
        ...
        <div className="mt-6">
          ...
          <div className="rounded-md border border-white/10   backdrop-blur-sm">
            <Table>
              <TableHeader>
