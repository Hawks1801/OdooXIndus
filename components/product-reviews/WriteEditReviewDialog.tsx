        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div>
            ...
            <Textarea
              ...
              className="min-h-[100px] rounded-xl mt-1 border bg-white/10 text-white placeholder:text-white/40 focus-visible:outline-none focus-visible:border focus-visible: focus-visible:ring-2 focus-visible:ring-amber-500/50 "
            />
          </div>
          <DialogFooter className="mt-6 flex flex-col sm:flex-row items-center gap-3">
            ...
            <Button
              ...
              className={cn(
                "h-11 rounded-xl border      text-white",
