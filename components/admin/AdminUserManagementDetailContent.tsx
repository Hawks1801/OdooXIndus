  ...
  return (
    <PageContentWrapper>
      <div className="space-y-6">
                  ...
                  {isProtected ? (
                    ...
                    <div className="flex gap-2 mt-1">
                      <Input
                        ...
                        disabled={isUpdating}
                        className="rounded-[28px] dark:border-white/10"
                      />
                      {nameTouched && (
                        <Button
                          size="sm"
        ...
        {overview && (
          <GlassCard variant="sky">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <Link
                href="/admin/orders"
                className="flex items-center gap-2 p-3 rounded-xl border dark:border-white/10 bg-white/30 dark:bg-white/5 hover:bg-white/50 dark:hover:bg-white/10 transition-colors"
              >
              ...
              <div className="flex items-center gap-2 p-3 rounded-xl border dark:border-white/10 bg-white/30 dark:bg-white/5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4 pt-4 border-t dark:border-white/10">
              <Link
                href="/admin/products"
                className="flex items-center gap-2 p-3 rounded-xl border dark:border-white/10 bg-white/30 dark:bg-white/5 hover:bg-white/50 dark:hover:bg-white/10 transition-colors"
              >
        ...
        {/* Danger Zone */}
        <GlassCard variant="rose" className="">
          <div className="flex items-center gap-3 mb-4">
            <div
              className={cn(
                "p-2.5 rounded-xl border  bg-rose-100/50",
                " dark:bg-rose-500/20",
              )}
            >
