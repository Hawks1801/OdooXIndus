        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {periodSelectMounted ? (
            ...
            >
              <SelectTrigger
                className={cn(
                  "w-full sm:w-[180px] h-10 rounded-[28px] border  ",
                  "      ",
                  "text-gray-700 dark:text-white  backdrop-blur-sm",
              ...
              <SelectContent
                className="rounded-xl bg-white/95 dark:bg-popover/95 "
                position="popper"
              >
                {PERIODS.map((p) => (
                  <SelectItem
          ...
          <Table>
            <TableHeader>
              {table.getHeaderGroups().map((headerGroup) => (
                <TableRow
                  key={headerGroup.id}
                  className="dark:border-white/10 bg-white/40 dark:bg-white/5 hover:bg-transparent"
                >
            ...
            <TableBody>
              {table.getRowModel().rows.map((row) => (
                <TableRow
                  key={row.id}
                  className="dark:border-white/5 hover:bg-white/30 dark:hover:bg-white/5"
                >
