...
function getStatusBadgeClassName(
  ...
  switch (recommendation) {
    case "urgent":
      return " bg-red-500/15 text-red-700 dark:text-red-300 dark:bg-red-500/20 ";
    case "soon":
      return " bg-amber-500/15 text-amber-800 dark:text-amber-300 dark:bg-amber-500/20 ";
    case "overstocked":
    ...
    case "normal":
    default:
      return " bg-emerald-500/15 text-emerald-800 dark:text-emerald-300 dark:bg-emerald-500/20 ";
  }
}
