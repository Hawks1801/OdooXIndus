  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button className="gap-2 h-10 font-semibold inline-flex items-center justify-center rounded-xl border text-white  backdrop-blur-sm transition duration-200 dark:">
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-[22px] text-white flex items-center gap-3">
            <div className="p-2 rounded-xl border bg-blue-100/50 dark:bg-blue-500/20">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className="h-11 pr-10 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-blue-500/50 "
              />
              <Button
                type="button"
                variant="ghost"
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-blue-500/50 ">
          ...
          <DialogFooter className="mt-6 flex flex-col sm:flex-row items-center gap-3">
            <DialogClose asChild>
              <Button
                type="button"
                variant="secondary"
                className="h-11 w-full sm:w-auto px-8 inline-flex items-center justify-center rounded-xl border border-white/10 dark:bg-background/50 backdrop-blur-sm   transition duration-200 dark:hover:bg-accent/50 hover:border-white/20 dark:hover:border-white/20"
                disabled={isPending}
              >
                Cancel
              </Button>
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="h-11 w-full sm:w-auto px-8 inline-flex items-center justify-center rounded-xl border text-white  backdrop-blur-sm transition duration-200 dark:  disabled:opacity-50"
            >
              {isPending ? (
                <>
