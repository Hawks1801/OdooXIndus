...
export default function SupportTicketFilters({
  ...
  const statusTriggerClass =
    "h-10 rounded-[28px] border          text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200     dark:   ";
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
      ...
      {onViewFilterChange &&
        (!viewSelectMounted ? (
          <div
            className="h-10 w-[180px] rounded-[28px] border bg-white/10 dark:bg-white/5 text-gray-900 dark:text-white flex items-center justify-between px-3 py-2"
            aria-hidden
          >
          ...
          >
            <SelectTrigger
              className="h-10 w-[180px] rounded-[28px] border bg-white/10 dark:bg-white/5 text-gray-900 dark:text-white"
            >
