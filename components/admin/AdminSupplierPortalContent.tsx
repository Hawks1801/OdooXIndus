          ...
          <GlassCard variant="sky">
            ...
            {stats && stats.recentProducts.length > 0 && (
              <Button
                ...
                size="sm"
                asChild
                className="mt-3 w-full rounded-xl border dark:border-white/10"
              >
        ...
        <GlassCard variant="violet">
          ...
          {loading || !stats ? (
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="border-b dark:border-white/10 text-left text-gray-600 dark:text-gray-400">
          ...
          {stats && stats.suppliers.length > 0 && (
            <Button
              ...
              size="sm"
              asChild
              className="mt-4 w-full rounded-xl border dark:border-white/10"
            >
