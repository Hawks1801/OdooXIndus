...
function getStatusBadgeClasses(status: OrderStatus): string {
  switch (status) {
    ...
    case "shipped":
      return "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/50 dark:text-indigo-200 border ";
    case "delivered":
      return "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-200 border ";
    case "cancelled":
      return "bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-200 border ";
    default:
      ...
      <div className="mx-auto space-y-6">
                  ...
                  <div className="sm:col-span-2 p-3 rounded-xl border">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {order.orderProductOwners.map((owner) => (
                        <span
                          key={owner.userId}
                          className="inline-flex items-center gap-1 rounded-md bg-white/50 dark:bg-white/10 px-2 py-1 text-xs border text-gray-900 dark:text-white"
                        >
        ...
        {order.shippingAddress && (
          <GlassCard variant="violet">
            ...
            <p className="text-sm text-gray-900 dark:text-white p-3 rounded-xl border">
        ...
        <GlassCard variant="teal">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-lg font-semibold p-3 rounded-xl border">
              ...
              <>
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  <ShippingManagement
                    order={order}
                    trigger={
                      <Button className="gap-2 rounded-xl border text-white  ">
