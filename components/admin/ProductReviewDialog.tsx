      ...
      >
        <DialogHeader>
          <DialogTitle className="text-[22px] text-white flex items-center gap-3">
            <div className="p-2 rounded-xl border bg-amber-100/50 dark:bg-amber-500/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            ...
            >
              <SelectTrigger
                ...
                className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-amber-500/50 "
              >
                <SelectValue placeholder="Select product to review" />
              </SelectTrigger>
              <SelectContent
                className="dark:border-white/10 bg-white/80 dark:bg-popover/50 backdrop-blur-sm z-[100] max-h-[200px]"
                position="popper"
                sideOffset={5}
                align="start"
              >
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              disabled={isPending}
              className="min-h-[120px] dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-amber-500/50  resize-none"
              maxLength={2000}
            />
