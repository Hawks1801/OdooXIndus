  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          variant="secondary"
          className="h-10 rounded-[28px] border text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200"
        >
      ...
      <PopoverContent
        className="p-0 w-52 poppins rounded-[28px] border dark:border-white/10 bg-white/80 dark:bg-popover/50 backdrop-blur-sm "
        side="bottom"
        align="start"
      >
