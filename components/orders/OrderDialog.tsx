            ...
            <form onSubmit={editFormMethods.handleSubmit(handleUpdateOrder)}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    <SelectTrigger className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-violet-500/50 ">
                ...
                <FormField
                  ...
                  inputClassName=" dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible: focus-visible:ring-violet-500/50 "
                />
                ...
                currentStatus === "delivered" ? (
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      type="date"
                      className="h-11 w-full rounded-md border dark:border-white/20 bg-white/10 dark:bg-white/5 px-3 py-2 text-white placeholder:text-white/40 focus:ring-violet-500/50 "
                      defaultValue={
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      variant="secondary"
                      className="h-10 rounded-[28px] border text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200 dark:"
                    >
                  ...
                  {fields.map((field, index) => {
                    ...
                    return (
                      <div
                        key={field.id}
                        className="p-4 border rounded-lg bg-white/5 space-y-3"
                      >
                          ...
                          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Input
                                ...
                                className="h-11 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible: focus:ring-violet-500/50 focus-visible:ring-violet-500/50  [&:invalid]: [&:invalid]: [&:invalid]:focus-visible:"
                              />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="h-4 w-4 rounded bg-white/10 text-violet-500 focus:ring-violet-500/50 data-[state=checked]:bg-violet-500/70"
                    />
                    <Label
