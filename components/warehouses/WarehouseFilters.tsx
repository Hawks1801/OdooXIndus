      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        ...
        <div className="relative flex-1 sm:max-w-md">
          ...
          <Input
            ...
            className="h-10 pl-9 pr-10 w-full rounded-[28px] bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 focus-visible: focus-visible:ring-teal-500/50 "
          />
          {searchTerm && (
            <Button
              variant="ghost"
        ...
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
          {!selectMounted ? (
            <div
              className="h-10 w-full sm:w-[180px] rounded-[28px] border text-gray-700 dark:text-white  backdrop-blur-sm font-medium flex items-center justify-between px-3 py-2.5 text-sm"
              aria-hidden
            >
            ...
            >
              <SelectTrigger className="h-10 w-full sm:w-[180px] rounded-[28px] border text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200 dark: font-medium">
                <SelectValue placeholder="All Warehouses" />
              </SelectTrigger>
              <SelectContent className="rounded-[28px] border dark:border-white/10 bg-white/80 dark:bg-popover/50 backdrop-blur-sm ">
                <SelectItem
                  value="all"
        ...
        <div className="flex-shrink-0">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                className="h-10 w-full sm:w-auto flex items-center gap-2 rounded-[28px] border text-gray-700 dark:text-white  backdrop-blur-sm transition duration-200 dark:"
              >
      ...
      {hasActiveFilter && (
        <div className="inline-flex items-center gap-1 px-2 py-1 text-xs border text-gray-700 dark:text-white rounded-md backdrop-blur-sm ">
          ...
          <div className="flex gap-1 items-center">
            <Badge className="border text-white backdrop-blur-sm">
