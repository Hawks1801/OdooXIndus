          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 mt-4">
            <div className="flex items-center gap-3">
              ...
              {!pageSizeSelectMounted ? (
                <div
                  className="h-10 rounded-[28px] border text-gray-700 dark:text-white w-16 sm:w-20 flex items-center justify-between px-2"
                  aria-hidden
                >
                ...
                >
                  <SelectTrigger className="h-10 rounded-[28px] border text-gray-700 dark:text-white w-16 sm:w-20">
            ...
            <div className="flex items-center justify-center sm:justify-end gap-2 sm:gap-4">
              <Button
                ...
                className="h-10 rounded-[28px] border"
              >
                <BiFirstPage />
              </Button>
              <Button
