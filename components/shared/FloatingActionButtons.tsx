      ...
      {variant === "home" && (
        ...
        >
          <AddProductDialog allProducts={allProducts} userId={userId}>
            <Button
              className={`h-14 rounded-lg bg-primary text-primary-foreground shadow-sm transition-all duration-300 hover:bg-primary/90 flex items-center justify-center gap-2 ${
