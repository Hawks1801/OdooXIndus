  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-3">
      ...
      {!mounted ? (
        ...
        >
          <SelectTrigger className="border border-white/20 dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-gray-700 dark:text-white/80 placeholder:text-white/40 focus:ring-sky-500/50  rounded-[28px] px-2 w-full sm:w-14 h-10">
