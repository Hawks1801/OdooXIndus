...
export default function PaymentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="poppins max-h-[90vh] flex flex-col overflow-hidden pl-4 sm:pl-8 pt-4 sm:pt-7 pb-4 sm:pb-7 pr-0  ">
        ...
        <div className="flex flex-col gap-6 overflow-y-auto min-h-0 flex-1 w-full">
          ...
          <div className="rounded-lg border dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm p-4 space-y-3 flex-shrink-0  ">
          ...
          <div className="flex flex-col gap-2 flex-shrink-0">
            ...
            <Button
              ...
              disabled={isLoading}
              className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border text-white   backdrop-blur-sm transition duration-200 dark:  dark: focus-visible:ring-sky-500/50"
            >
              {isLoading ? (
                <>
