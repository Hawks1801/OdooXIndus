 ...
 * Uses indigo glassmorphic styling (, shadow indigo)
 */
            ...
            <form onSubmit={editFormMethods.handleSubmit(handleUpdateInvoice)}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    <SelectTrigger className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-indigo-500/50 ">
                ...
                <FormNumberField
                  ...
                  inputClassName="h-11  dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible: focus-visible:ring-indigo-500/50 "
                />

                {/* Order Pricing Summary (read-only — values come from the order) */}
                <div className="sm:col-span-2 p-4 border rounded-lg bg-white/5 space-y-2">
                  ...
                  <div className="flex justify-between text-base font-semibold text-white pt-2 border-t">
                    <span>Total:</span>
                ...
                <FormField
                  ...
                  type="date"
                  labelClassName="text-white/80"
                  inputClassName=" dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible: focus-visible:ring-indigo-500/50 "
                />
              ...
              <DialogFooter className="mt-9 mb-4 flex flex-col sm:flex-row items-center gap-4">
                ...
                <Button
                  type="submit"
                  className="h-11 w-full sm:w-auto px-11 inline-flex items-center justify-center rounded-xl border text-white  backdrop-blur-sm transition duration-200 "
                  disabled={isUpdating}
                >
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedOrderId} onValueChange={setSelectedOrderId}>
                <SelectTrigger
                  id="order-select"
                  className="w-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder:text-white/40 focus-visible: focus-visible:ring-indigo-500/50 "
                >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder:text-white/40 focus-visible: focus-visible:ring-indigo-500/50  pr-10"
