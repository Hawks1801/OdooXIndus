...
export default function ShippingManagement({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="p-4 sm:p-7 sm:px-8 poppins max-h-[90vh] overflow-y-auto flex flex-col overflow-hidden gap-8  ">
        ...
        <div className="flex flex-col gap-4 overflow-y-auto flex-1 pr-1 min-h-[340px]">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 h-11 p-1 rounded-lg bg-white/30 dark:bg-white/10 text-white shrink-0 border dark:border-white/20  ">
              <TabsTrigger
                value="auto"
                className="h-9 gap-2 rounded-md data-[state=active]:border data-[state=active]: data-[state=active]:ring-2 data-[state=active]:ring-emerald-500/50 data-[state=active]:bg-background data-[state=active]:text-slate-700 dark:data-[state=active]:text-white dark:data-[state=active]:bg-white/20 data-[state=active]:"
              >
                <Truck className="h-4 w-4" />
                Auto Generate
              </TabsTrigger>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    id="carrier"
                    className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus:ring-emerald-500/50  "
                  >
              ...
              <Button
                ...
                disabled={isLoading}
                className="h-11 w-full rounded-xl border text-white   backdrop-blur-sm transition duration-200 dark:  dark: focus-visible:ring-emerald-500/50"
              >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-11 w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-white placeholder:text-white/40 focus-visible: focus-visible:ring-emerald-500/50  "
                />
              </div>
