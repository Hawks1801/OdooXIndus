...
export default function OrderTrackingInfo({
  ...
  return (
    <article
      className={cn(
        "rounded-[28px] border   p-4 sm:p-5 backdrop-blur-sm transition-all duration-300",
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          {trackingUrl && (
            <Button asChild className="flex-1 gap-2 rounded-xl border text-white   backdrop-blur-sm dark: transition-all duration-300 h-10">
              <a
                href={trackingUrl}
                target="_blank"
