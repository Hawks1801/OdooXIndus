        ...
        <PageContentWrapper className="px-1 sm:px-0">
          ...
          <div className="pb-6 flex flex-col sm:flex-row items-start justify-between gap-4">
            ...
            <Button
              ...
              className="flex items-center gap-2 flex-shrink-0 rounded-xl "
          ...
          {/* Date Range Filter */}
          <div className="pb-6">
            <div className="rounded-[16px] border p-4 backdrop-blur-sm ">
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex items-center gap-2">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg border bg-violet-100/50 dark:border-white/15 dark:bg-white/10">
                ...
                <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 flex-1">
                  ...
                  {(dateRange.startDate || dateRange.endDate) && (
                    <Button
                      ...
                      className="flex items-center gap-1 rounded-xl hover:bg-rose-500/10"
                    >
                      <X className="h-3 w-3" />
                      Clear
                    </Button>
          ...
          <div className="pb-6 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
            {/* Quick Insights Card */}
            <article className="rounded-[20px] border p-4 sm:p-5 backdrop-blur-sm   transition">
              <div className="flex items-center gap-2 mb-4">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-sky-100/50 dark:border-white/15 dark:bg-white/10">
            ...
            <article className="rounded-[20px] border p-4 sm:p-5 backdrop-blur-sm   transition">
              <div className="flex items-center gap-2 mb-4">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-emerald-100/50 dark:border-white/15 dark:bg-white/10">
