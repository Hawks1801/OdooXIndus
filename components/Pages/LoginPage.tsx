      ...
      <div className="relative z-10 w-full">
        <div className="flex flex-col lg:flex-row min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-8 lg:p-12">
            ...
            <div className="relative z-10 max-w-2xl w-full space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Admin */}
                <div className="rounded-[20px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 transition-all  dark:">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="rounded-xl border bg-sky-500/20 dark:bg-sky-500/10 backdrop-blur-sm p-2">
                ...
                <div className="rounded-[20px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 transition-all  dark:">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="rounded-xl border bg-emerald-500/20 dark:bg-emerald-500/10 backdrop-blur-sm p-2">
                ...
                <div className="rounded-[20px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 transition-all  dark:">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="rounded-xl border bg-amber-500/20 dark:bg-amber-500/10 backdrop-blur-sm p-2">
                ...
                <div className="rounded-[20px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 transition-all  dark:">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="rounded-xl border bg-violet-500/20 dark:bg-violet-500/10 backdrop-blur-sm p-2">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-0 sm:p-8 lg:p-12">
            <div className="w-full max-w-md rounded-[28px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 sm:p-8 transition-all duration-300  dark: dark:">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  {!selectMounted ? (
                    <div
                      className="flex h-11 w-full items-center justify-between rounded-md border dark:border-white/20 bg-white/10 dark:bg-white/5 px-3 py-2.5 text-sm text-gray-500 dark:text-white/40"
                      aria-hidden
                    >
                    ...
                    >
                      <SelectTrigger className="w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 focus:ring-sky-500/50">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 focus-visible: focus-visible:ring-sky-500/50 "
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full rounded-xl border text-white  backdrop-blur-sm transition duration-200 dark: "
              ...
              <Button
                ...
                disabled={isLoading || isNavigatingToHome}
                className="w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-gray-900 dark:text-white hover:bg-white/20 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white mb-6"
              >
                <svg
