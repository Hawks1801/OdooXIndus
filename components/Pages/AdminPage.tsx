...
const linkCardClass =
  "block border border-white/10 dark:border-white/10        backdrop-blur-sm   rounded-lg transition-all duration-200  dark:        dark:";

const disabledCardClass =
  "border border-white/10 dark:border-white/10        rounded-lg opacity-75";
