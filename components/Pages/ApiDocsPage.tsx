            ...
            {!isMounted ? (
              <>
                {[1, 2, 3, 4].map((i) => (
                  <article
                    key={i}
                    className="rounded-[20px] border border-gray-300/30 dark:border-white/10 min-h-[120px] p-4 sm:p-5 animate-pulse"
                  >
              ...
              <>
                ...
                <GlassCard variant="blue">
                  <div className="p-4 sm:p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-blue-100/50 dark:border-white/15 dark:bg-white/10">
                ...
                <GlassCard variant="violet">
                  <div className="p-4 sm:p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-violet-100/50 dark:border-white/15 dark:bg-white/10">
                ...
                <GlassCard variant="amber">
                  <div className="p-4 sm:p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-amber-100/50 dark:border-white/15 dark:bg-white/10">
                ...
                <GlassCard variant="teal">
                  <div className="p-4 sm:p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-teal-100/50 dark:border-white/15 dark:bg-white/10">
          ...
          <Tabs defaultValue="authentication" className="w-full">
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        <div
                          className={cn(
                            ...
                            variant === "violet" &&
                              " bg-violet-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "emerald" &&
                              " bg-emerald-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "sky" &&
                              " bg-sky-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "orange" &&
                              " bg-orange-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "blue" &&
                              " bg-blue-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "rose" &&
                              " bg-rose-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "teal" &&
                              " bg-teal-100/50 dark:border-white/15 dark:bg-white/10",
                            variant === "amber" &&
                              " bg-amber-100/50 dark:border-white/15 dark:bg-white/10",
                          )}
                        >
                                    ...
                                    (param, paramIndex) => (
                                      ...
                                      >
                                        ...
                                        {param.required && (
                                          <Badge
                                            variant="outline"
                                            className="text-xs bg-rose-500/10 text-rose-700 dark:text-rose-300"
                                          >
                                            Required
                                          </Badge>
                                        )}
                            ...
                            <div>
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                  <Badge className="bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border">
                                    Success
                                  </Badge>
                                ...
                                <div className="flex items-center gap-2">
                                  <Badge className="bg-rose-500/20 text-rose-700 dark:text-rose-300 border">
                                    Error
                                  </Badge>
                                  <span className="text-sm text-gray-600 dark:text-white/70">
            ...
            >
              <GlassCard variant="sky">
                <div className="p-4 sm:p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-sky-100/50 dark:border-white/15 dark:bg-white/10">
            ...
            >
              <GlassCard variant="rose">
                <div className="p-4 sm:p-5">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-rose-100/50 dark:border-white/15 dark:bg-white/10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Success Codes */}
                    <div className="rounded-xl border p-4 backdrop-blur-sm space-y-3">
                      <h4 className="font-medium text-emerald-700 dark:text-emerald-300 text-sm">
                        Success Codes
                      </h4>
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <Badge className="bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border font-mono">
                            200
                          </Badge>
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className="bg-blue-500/20 text-blue-700 dark:text-blue-300 border font-mono">
                            201
                          </Badge>
                          <span className="text-sm text-gray-700 dark:text-white/80">
                    ...
                    <div className="rounded-xl border p-4 backdrop-blur-sm space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          <Badge className="bg-rose-500/20 text-rose-700 dark:text-rose-300 border font-mono">
                            400
                          </Badge>
                          <span className="text-sm text-gray-700 dark:text-white/80">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className="bg-amber-500/20 text-amber-700 dark:text-amber-300 border font-mono">
                            429
                          </Badge>
                          <span className="text-sm text-gray-700 dark:text-white/80">
                            Too Many Requests
