        ...
        <div className="max-w-9xl mx-auto space-y-6">
          ...
          <GlassCard variant="orange">
            ...
            <div className="space-y-3 mt-4">
              ...
              {cancelledAt && (
                <div className="flex items-center gap-2 text-sm p-3 rounded-xl border border-gray-200/30 dark:border-gray-400/10">
            ...
            {invoice.status !== "paid" &&
              ...
              invoice.amountDue > 0 && (
                <PaymentDialog
                  ...
                  trigger={
                    <Button className="w-full sm:w-auto gap-2 rounded-xl border text-white  backdrop-blur-sm transition-all duration-300">
