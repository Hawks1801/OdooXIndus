              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                {category.products.map((product) => (
                  <Link
                    ...
                    className="flex items-center gap-3 p-4 rounded-xl border dark: transition-all duration-300"
                  >
                    {product.imageUrl && (
                      <div className="relative w-16 h-16 rounded-xl overflow-hidden bg-white/50 dark:bg-white/5 border flex-shrink-0">
                        <Image
              ...
              <div className="space-y-3 mt-4">
                {category.recentOrders.map((order) => (
                  <Link
                    ...
                    className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl border dark: transition-all duration-300"
                  >
                    <div className="flex-1">
