        ...
        <div className="max-w-9xl mx-auto space-y-6">
            ...
            <GlassCard variant="orange">
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-orange-100/50 dark:border-white/15 dark:bg-white/10">
          ...
          {product.recentOrders && product.recentOrders.length > 0 && (
            <GlassCard variant="rose">
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl border bg-rose-100/50 dark:border-white/15 dark:bg-white/10">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-4">
            ...
            <Button
              ...
              className="w-full sm:w-auto gap-2 rounded-xl border text-white "
            >
