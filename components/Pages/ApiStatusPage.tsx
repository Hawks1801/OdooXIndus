...
export default function ApiStatusPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "OK":
      case "HEALTHY":
        return "bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border ";
      case "ERROR":
      case "DOWN":
        return "bg-rose-500/20 text-rose-700 dark:text-rose-300 border ";
      case "TIMEOUT":
      case "DEGRADED":
        return "bg-amber-500/20 text-amber-700 dark:text-amber-300 border ";
      case "NOT_CONFIGURED":
        ...
        <div className="space-y-6">
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-emerald-100/50 dark:border-white/15 dark:bg-white/10">
            ...
            <div className="p-4 sm:p-5">
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-violet-100/50 dark:border-white/15 dark:bg-white/10">
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Database */}
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-xl border backdrop-blur-sm gap-2">
                    <div className="flex items-center gap-3">
          ...
          {systemStatus?.performance && (
            <GlassCard variant="orange">
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-orange-100/50 dark:border-white/15 dark:bg-white/10">
          ...
          {systemStatus?.systemMetrics && (
            <GlassCard variant="teal">
              <div className="p-4 sm:p-5">
                <div className="flex items-center gap-3 mb-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl border bg-teal-100/50 dark:border-white/15 dark:bg-white/10">
