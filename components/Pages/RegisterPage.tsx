      ...
      <div className="relative z-10 w-full">
        <div className="flex flex-col lg:flex-row min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-8 lg:p-12">
            ...
            <div className="relative z-10 max-w-lg w-full space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-[20px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 transition-all  dark:">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="rounded-xl border bg-blue-500/20 dark:bg-blue-500/10 backdrop-blur-sm p-2">
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-0 sm:p-8 lg:p-12">
            <div className="w-full max-w-md space-y-6 rounded-[28px] border dark:border-white/10 backdrop-blur-sm  dark:shadow-lg p-4 sm:p-8 transition-all duration-300  dark: dark:">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="w-full bg-white/10 dark:bg-white/5 backdrop-blur-sm border dark:border-white/20 text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/40 focus-visible: focus-visible:ring-emerald-500/50 "
                  />
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full rounded-xl border text-white  backdrop-blur-sm transition duration-200"
                  disabled={isLoading}
                >
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full dark:border-white/20 bg-white/10 dark:bg-white/5 backdrop-blur-sm text-gray-900 dark:text-white hover:bg-white/20 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white"
              >
                <svg
