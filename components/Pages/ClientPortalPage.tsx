      ...
      <Navbar>
        <PageContentWrapper>
          <div className="space-y-6">
            ...
            <article
              className={cn(
                "rounded-[28px] border border-white/10 dark:border-white/20 p-4 sm:p-6 backdrop-blur-sm bg-white/60 dark:bg-white/5  ",
              )}
            >
      ...
      <PageContentWrapper>
        <div className="space-y-6">
          ...
          {dashboard.monthlySpending.length > 0 && (
            <article
              className={cn(
                "rounded-[28px] border   p-4 sm:p-6 backdrop-blur-sm transition-all",
