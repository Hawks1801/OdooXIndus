    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:border-2 focus-visible: focus-visible:ring-2 focus-visible:ring-sky-500/20",
          "dark:border-white/20 dark:bg-white/5 dark:text-white dark:placeholder:text-white/50 dark:focus-visible: dark:focus-visible:ring-sky-400/30",
          className
        )}
        ref={ref}
        {...props}
