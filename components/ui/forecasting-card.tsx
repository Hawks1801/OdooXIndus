          ...
          <div className="space-y-2">
            {forecastData.reorderSuggestions.length > 0 ? (
              forecastData.reorderSuggestions.map((suggestion, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 rounded-xl border border-gray-300/30 dark:border-white/10 backdrop-blur-sm"
                >
          ...
          <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-2">
            {forecastData.seasonalTrends.map((trend, index) => (
              <div
                key={index}
                className={cn(
                  "text-center p-2 rounded-xl border border-gray-300/20    dark:border-white/10 ",
